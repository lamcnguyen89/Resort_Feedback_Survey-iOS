...
class FoodViewController: UIViewController {
    ...
    @IBAction func submitFeedback(_ sender: Any) {
        ...
        let questionsPerCategory = QuestionsHelper.inst.getCategory(category: "Food" ).count
        ...
        let wel = sb.instantiateViewController(withIdentifier: "Overall") as! OverallViewController
    ...
    func loadQuestions() {
        let data = QuestionsHelper.inst.getCategory(category: "Food" )
