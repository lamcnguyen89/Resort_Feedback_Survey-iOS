...
class OverallViewController: UIViewController {
    ...
    @IBAction func submitFeedback(_ sender: Any) {
        ...
        let questionsPerCategory = QuestionsHelper.inst.getCategory(category: "Overall" ).count
        ...
        // Return to the Welcome Screen which contains special offers after completing all the survey questions
    ...
    func loadQuestions() {
        let data = QuestionsHelper.inst.getCategory(category: "Overall" )
