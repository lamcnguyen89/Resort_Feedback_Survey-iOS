...
class RoomViewController: UIViewController {
    ...
    @IBAction func submitFeedback(_ sender: Any) {
        ...
        print("Number of Questions Answered: \(ud.integer(forKey: "questionTracker"))")
        
        let sb : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let wel = sb.instantiateViewController(withIdentifier: "Gym") as! GymViewController
    ...
    func loadQuestions() {
        let data = QuestionsHelper.inst.getCategory(category: "Room" )
